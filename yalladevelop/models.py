...
class Payment(models.Model):
    id = models.AutoField(primary_key=True)
    user = models.ForeignKey(User, unique=False, null=True, on_delete=models.CASCADE)
    project = models.ForeignKey(Project, unique=False, null=False, on_delete=models.CASCADE)
